...
export async function fetchNewColor() {
  ...
  const hexCodeClosestNamedColor = data.name.closest_named_hex;
  const nameRandomColor = data.name.value;

  setColorToGuess(hexCodeClosestNamedColor, nameRandomColor);
  // --^-- your code here --^--
}
