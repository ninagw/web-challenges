...
function findByLastName(employees, lastName) {
  ...
  //const findEmployee = employeesList.find((employee) => employee.lastName === lastName.value)
  //return findEmployee;
...
function findByCitySubString(employees, string) {
  const findCity = employees.find((employee) => employee.city === string);
  return findCity;
}
...
function findByProfessionSubStringAndAge(employees, string, age) {
  return (
    employees.find((employee) => employee.profession === string) &&
